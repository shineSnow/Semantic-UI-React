...
describe('Transition', () => {
  ...
  describe('constructor', () => {
    ...
    it('sets statutes when `transitionAppear` is false', () => {
      wrapperShallow(
    ...
    it('updates status after mount', () => {
      wrapperMount(<Transition><p /></Transition>)
  ...
  describe('into', () => {
    ...
    it('updates status when set to true while UNMOUNTED', () => {
      wrapperShallow(
        <Transition into={false} mountOnEnter={false}>
          <p />
        </Transition>
      )
  ...
  describe('onHide', () => {
    it('is called with (null, props) when hidden', done => {
      ...
      const handleHide = (...args) => {
        ...
        onHide.should.have.been.calledWithMatch(null, { duration: 0, status: Transition.UNMOUNTED })
